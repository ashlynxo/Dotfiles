...
theme.nerd_font = 'CaskaydiaCove Nerd Font'
theme.font_size = '10'
theme.font = theme.font_name .. ' ' .. theme.font_size

-- base colors
theme.black = '#1b1f2e'
theme.light_black = '#343b55'
theme.red = '#ff6b8b'
theme.yellow = '#f9d56e'
...
-- backgrounds
theme.bg_normal     = "#070912"
theme.bg_contrast   = "#0d1020"
theme.bg_lighter    = "#11162a"
